...
{ 
  ...
  try
  {
    if (isset($_GET['Audience']) || $_SESSION['sort'] == 'Audience' || $_SESSION['sort'] ==! 'Alphabetically'){
    $_SESSION['sort'] = 'Audience'; 
    ...
    if (isset($_GET['Alphabetically']) || $_SESSION['sort'] == 'Alphabetically ' || $_SESSION['sort'] ==! 'Audience'){
    $_SESSION['sort'] = 'Alphabetically';
