    ...
    echo "
      <form action=\"UserAdministration.php\" method=\"post\">
        ...
        <tr>
          ...
          <td>
            <input type=\"submit\" class=\"btn btn-primary\" id=\"buttondesign\" name=\"EditUser\"value=\"Aanpassen\">
          </td> 
          <td>
            <input type=\"submit\" class=\"btn btn-primary\" id=\"buttondesign\" name=\"DeleteUser\"value=\"Verwijderen\">
          </td>
        </tr>
      </form>
    "; 
