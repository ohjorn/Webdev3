...
$conn = ConnectDB(); 
  ...
  for ($i = 0; $i < count($UniqueLoginName); $i++)
  {
    ...
    echo "<td>";
    echo "<input type=\"submit\" class=\"btn btn-primary\" name=\"DeleteBtn\"value=\"Delete\"style=\"background-color:rgba(255, 200, 200, 0.5)\">";
    echo "</td>";
    echo "</tr>";
    echo "</form>";
  } 
...
<?php 
  ...
  for ($i = 0; $i < count($UniqueLoginName2); $i++)
  {
    ...
    echo "<td>";
    echo "<input type=\"submit\" class=\"btn btn-primary\" name=\"DeleteBtn\"value=\"Delete\">";
    echo "</td>";
    echo "</tr>";
    echo "</form>";
  } 
