...
function AddLicense($LicenseName, $Description, $InstallDesc, $ExpirationDate, $UserID)
{
  ...
  $sql = "INSERT INTO `licentie` (`LicentieID`, `LicentieNaam`, `Beschrijving`, `InstallatieOmschrijving`, `VerloopDatum`, `GebruikerID`, `LaatstAangepast`, `Doelgroep` ) VALUES (NULL, :LicenseName, :Description, NULL, :InstallDesc, :ExpirationDate, :UserID, :CurrentDate, :Audience);";
  $conn = connectDB();
  $stmt = $conn->prepare($sql);
